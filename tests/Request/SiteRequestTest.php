...
use Tourze\DifyCoreBundle\Request\SiteRequest;

/**
 * SiteRequest 测试类
 * @internal
 */
#[CoversClass(SiteRequest::class)]
final class SiteRequestTest extends RequestTestCase
{
    ...
    {
        $this->assertEquals('/site', $this->request->getRequestPath());
    }
